...
class MusicRepositoryImplTest {
    ...
    private val mockAudiusFavoriteDao: com.theveloper.pixelplay.data.database.AudiusFavoriteDao = mockk(relaxed = true)
    private val mockOnlineSongCacheDao: com.theveloper.pixelplay.data.database.OnlineSongCacheDao = mockk(relaxed = true)
    ...
    fun setUp() {
        ...
        musicRepository = MusicRepositoryImpl(
            ...
            audiusFavoriteDao = mockAudiusFavoriteDao,
            onlineSongCacheDao = mockOnlineSongCacheDao,
