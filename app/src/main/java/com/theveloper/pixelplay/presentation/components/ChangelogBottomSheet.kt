...
private fun changelogVersions(): List<ChangelogVersion> = listOf(
    ...
    ChangelogVersion(
        ...
        date = "2026-08-28",
        sections = listOf(
            ChangelogSection(R.string.changelog_sec_added, R.array.changelog_087_added),
            ChangelogSection(R.string.changelog_sec_improvements, R.array.changelog_087_improvements),
            ChangelogSection(R.string.changelog_sec_fixes, R.array.changelog_087_fixes)
        )
    ),
    ChangelogVersion(
        version = "0.7.22",
        date = "2026-08-24",
        sections = listOf(
            ChangelogSection(R.string.changelog_sec_added, R.array.changelog_0722_added),
            ChangelogSection(R.string.changelog_sec_fixes, R.array.changelog_0722_fixes)
        )
    ),
    ChangelogVersion(
        version = "0.7.21",
    ...
    ChangelogVersion(
        ...
        date = "2026-08-23",
        sections = listOf(
            ChangelogSection(R.string.changelog_sec_fixes, R.array.changelog_0715_fixes),
            ChangelogSection(R.string.changelog_sec_added, R.array.changelog_0715_added),
            ChangelogSection(R.string.changelog_sec_improvements, R.array.changelog_0715_improvements)
        )
    ),
    ChangelogVersion(
        version = "0.7.14",
        date = "2026-08-23",
        sections = listOf(
            ChangelogSection(R.string.changelog_sec_fixes, R.array.changelog_0714_fixes)
        )
    ),
    ChangelogVersion(
        version = "0.7.13",
        date = "2026-08-23",
        sections = listOf(
            ChangelogSection(R.string.changelog_sec_fixes, R.array.changelog_0713_fixes),
            ChangelogSection(R.string.changelog_sec_improvements, R.array.changelog_0713_improvements)
        )
    ),
    ChangelogVersion(
        version = "0.7.12",
        date = "2026-08-23",
        sections = listOf(
            ChangelogSection(R.string.changelog_sec_fixes, R.array.changelog_0712_fixes)
        )
    ),
    ChangelogVersion(
        version = "0.7.11",
        date = "2026-08-23",
        sections = listOf(
            ChangelogSection(R.string.changelog_sec_fixes, R.array.changelog_0711_fixes)
        )
    ),
    ChangelogVersion(
        version = "0.7.10",
        date = "2026-08-22",
        sections = listOf(
            ChangelogSection(R.string.changelog_sec_fixes, R.array.changelog_0710_fixes)
        )
    ),
    ChangelogVersion(
        version = "0.7.9",
        date = "2026-08-22",
        sections = listOf(
            ChangelogSection(R.string.changelog_sec_fixes, R.array.changelog_079_fixes)
        )
    ),
    ChangelogVersion(
        version = "0.7.5",
...
fun ChangelogBottomSheet(
    ...
    val changelogUrl = "https://github.com/anshdeepofficial/VYBE/blob/main/CHANGELOG.md"
