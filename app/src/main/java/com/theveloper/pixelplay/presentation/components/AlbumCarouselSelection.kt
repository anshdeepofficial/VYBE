            ...
            content = { index ->
                ...
                Box(
                    Modifier
                        ...
                        .aspectRatio(1f)
                        .clickable(
                            enabled = isFocusedItem && (
                                !song.remoteAlbumBrowseId.isNullOrBlank() || song.albumId > 0L
                            ),
                    ...
                    val isOnlineLandscapeArtwork = song.id.startsWith("yt_") ||
                        song.contentUriString.startsWith("yt://")
                    if (isOnlineLandscapeArtwork) {
