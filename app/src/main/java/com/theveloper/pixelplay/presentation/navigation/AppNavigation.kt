...
import com.theveloper.pixelplay.presentation.screens.ChangelogScreen
...
import com.theveloper.pixelplay.presentation.screens.SettingsSearchScreen
    ...
    startDestination?.let { initialRoute ->
        NavHost(
            ...
            composable(Screen.OnlineSearch.route) {
                ScreenWrapper(navController = navController, playerViewModel = playerViewModel, animatedVisibilityScope = this) {
                    com.theveloper.pixelplay.presentation.screens.OnlineSearchScreen(
                        navController = navController,
                        playerViewModel = playerViewModel,
                        paddingValuesParent = paddingValues
                    )
...
private fun String.toRoute(): String = when (this) {
    LaunchTab.SEARCH -> Screen.OnlineSearch.route
    LaunchTab.LIBRARY -> Screen.Library.route
    LaunchTab.HOME -> Screen.Home.route
