...
@Database(
    entities = [
        AudiusFavoriteEntity::class,
        OnlineSongCacheEntity::class,
...
abstract class PixelPlayDatabase : RoomDatabase() {
    ...
    abstract fun audiusFavoriteDao(): AudiusFavoriteDao
    abstract fun onlineSongCacheDao(): OnlineSongCacheDao
    ...
    companion object {
        ...
        val MIGRATION_43_44 = object : Migration(43, 44) {
            override fun migrate(db: SupportSQLiteDatabase) {
                db.execSQL(
                    "CREATE TABLE IF NOT EXISTS `downloaded_songs` (`id` TEXT NOT NULL, `title` TEXT NOT NULL, `artist` TEXT NOT NULL, `album` TEXT NOT NULL, `albumArtUrl` TEXT, `duration` INTEGER NOT NULL, `localFilePath` TEXT NOT NULL, `mimeType` TEXT NOT NULL, `bitrate` INTEGER NOT NULL, `downloadedAt` INTEGER NOT NULL, PRIMARY KEY(`id`))"
                )
            }
        }
        ...
        val MIGRATION_44_45 = object : Migration(44, 45) {
            override fun migrate(db: SupportSQLiteDatabase) {
                db.execSQL(
                    "CREATE TABLE IF NOT EXISTS `online_song_cache` (`id` TEXT NOT NULL, `title` TEXT NOT NULL, `artist` TEXT NOT NULL, `album` TEXT NOT NULL, `albumArtUrl` TEXT, `duration` INTEGER NOT NULL, `path` TEXT NOT NULL, `contentUri` TEXT NOT NULL, `mimeType` TEXT, PRIMARY KEY(`id`))"
                )
            }
        }
