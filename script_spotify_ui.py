...
with open('app/src/main/java/com/theveloper/pixelplay/presentation/screens/SpotifySettingsSection.kt', 'r', encoding='utf-8') as f:
    content = f.read()

new_content = """package com.theveloper.pixelplay.presentation.screens
...
with open('app/src/main/java/com/theveloper/pixelplay/presentation/screens/SpotifySettingsSection.kt', 'w', encoding='utf-8') as f:
    f.write(new_content)
